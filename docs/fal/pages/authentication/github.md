---
title: GitHub Authentication Authentication
source_url: https://docs.fal.ai/model-apis/authentication/github
fetched_at: 2025-10-27 03:52:13
---
...
an error that you should reach out to [[email protected]](/cdn-cgi/l/email-protection#1d6e686d6d726f695d7b7c71337c74). Shoot us an email with how
...
**Note:**Your login credentials are persisted on your local machine and cannot be transferred to another machine. If you want to use fal in your CI/CD, you will need to use [key-based credentials](/model-apis/authentication/key-based).
...
Previous](/model-apis/authentication/key-based)[Add fal.ai to your Next.js app Integration

Next](/model-apis/integrations/nextjs)
